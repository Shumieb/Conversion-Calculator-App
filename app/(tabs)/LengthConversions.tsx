import { HandlecmConversions, HandleKmConversions, HandlemConversions, HandlemmConversions } from '@/utils/pageHelpers/LengthPageHelpers';
...
const LengthConversions = () => {
    ...
    const [valueOutput, setValueOutput] = useState("m");
    ...
    const HandleConversion = (val: string, type: string) => {
        ...
        if (numberVal && numberVal < 0) {
            ...
            switch (valToEvaluate) {
                case "km":
                    HandleKmConversions(val, valToSet, funcToSend, setErrorMsg, setError)
                    break
                case "m":
                    HandlemConversions(val, valToSet, funcToSend, setErrorMsg, setError)
                    break
                case "cm":
                    HandlecmConversions(val, valToSet, funcToSend, setErrorMsg, setError)
                    break
                case "mm":
                    HandlemmConversions(val, valToSet, funcToSend, setErrorMsg, setError)
                    break
                default:
