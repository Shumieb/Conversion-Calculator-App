...
export const KilometersToCentimeters = (kilometers) => {
    return kilometers * 100000;
}

export const KilometersToMilimeters = (kilometers) => {
...
export const MetersToCentimeters = (meters) => {
    return meters * 100;
}

export const MetersToMilimeters = (meters) => {
    return meters * 1000;
}
